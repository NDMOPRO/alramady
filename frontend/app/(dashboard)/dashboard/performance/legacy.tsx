          ...
          <div className="p-6 space-y-4">
            ...
            {!loadingOptimized && optimizedData && (
              <div className="space-y-3">
                ...
                {/* Data preview table */}
                {optimizedData.data && Array.isArray(optimizedData.data) && optimizedData.data.length > 0 && (
                  <div className="overflow-hidden rounded-xl border border-gray-100">
                    <div className="overflow-x-auto">
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-gray-100 bg-gradient-to-l from-gray-50/80 to-white">
                            {Object.keys(optimizedData.data[0] as Record<string, unknown>).map((key) => (
                              <th
                                key={key}
                        ...
                        <tbody>
                          {(optimizedData.data as Record<string, unknown>[]).slice(0, 10).map(
                            (row, idx) => (
                              <tr
                                key={idx}
                ...
                {optimizedData.data && !Array.isArray(optimizedData.data) && (

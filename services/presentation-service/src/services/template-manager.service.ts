  ...
  async createTemplate(
    ...
    await this.prisma.slideTemplate.create({
      data: {
        ...
        elements: template.elements as unknown as Record<string, unknown>,
        backgroundColor: template.backgroundColor,
        transitions: template.transitions as unknown as Record<string, unknown>,
  ...
  async updateTemplate(
    ...
    await this.prisma.slideTemplate.update({
      ...
      data: {
        ...
        elements: updated.elements as unknown as Record<string, unknown>,
        backgroundColor: updated.backgroundColor,
        transitions: updated.transitions as unknown as Record<string, unknown>,
        metadata: updated.metadata as unknown as Record<string, unknown>,

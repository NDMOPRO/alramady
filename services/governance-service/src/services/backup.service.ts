  ...
  async createBackupConfig(config: Omit<BackupConfig, 'id'>): Promise<BackupConfig> {
    ...
    await this.prisma.backupConfig.create({
      data: {
        ...
        databases: fullConfig.databases as Record<string, unknown>,
        storageTarget: fullConfig.storageTarget as Record<string, unknown>,
        retention: fullConfig.retention as Record<string, unknown>,
        encryption: fullConfig.encryption as Record<string, unknown>,
        compression: fullConfig.compression as Record<string, unknown>,
        notifications: fullConfig.notifications as Record<string, unknown>,

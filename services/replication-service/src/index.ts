...
const logger = winston.createLogger({
  ...
  defaultMeta: { service: 'replication-service' },
  transports: [
...
app.get('/api/v1/replication/ready', (_req, res) => {
...
import pixelValidationRoutes from './routes/pixel-validation.routes.js';
import advancedCapabilitiesRoutes from './routes/advanced-capabilities.routes.js';
import canonicalPipelineRoutes from './routes/canonical-pipeline.routes.js';
import generateFromLayoutRoutes from './routes/generate-from-layout.routes.js';
import visualReplicationRoutes from './routes/visual-replication.routes.js';
import strictReplicationRoutes from './routes/strict-replication.routes.js';
import corePrincipleRoutes from './routes/core-principle.js';
import dualVerifyRoutes from './routes/dual-verify.js';
import imageMatchingRoutes from './routes/image-matching.js';
...
app.use('/api/v1/replication', advancedCapabilitiesRoutes);
app.use('/api/v1/replication', canonicalPipelineRoutes);
app.use('/api/v1/replication', generateFromLayoutRoutes);
app.use('/api/v1/replication', visualReplicationRoutes);
app.use('/api/v1/replication', strictReplicationRoutes);
app.use('/api/v1/replication/core-principle', corePrincipleRoutes);
app.use('/api/v1/replication/dual-verify', dualVerifyRoutes);
app.use('/api/v1/replication/image-matching', imageMatchingRoutes);

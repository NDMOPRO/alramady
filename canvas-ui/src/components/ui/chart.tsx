...
function ChartTooltipContent({
  ...
  labelKey,
    ...
    active?: boolean;
    payload?: Array<{ name?: string; value?: number | string; dataKey?: string | number; color?: string; payload?: Record<string, unknown> }>;
    label?: string;
          ...
          return (
            ...
            >
              {formatter && item?.value !== undefined && item.name ? (
                formatter(item.value, item.name, item as Record<string, unknown>, index, payload as Array<Record<string, unknown>>)
              ) : (
                <>
                  {!hideIndicator && (
                    <div
...
function getPayloadConfigFromPayload(
  ...
  if (
    ...
    const payloadKey = Object.keys(payloadPayload).find(
      (k) => k !== "value" && payloadPayload[k] !== undefined
    );
